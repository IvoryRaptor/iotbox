...
func (*ActorRef) Descriptor() ([]byte, []int) { return fileDescriptorProtos, []int{0} }

func (m *ActorRef) GetAddress() string {
	if m != nil {
		return m.Address
	}
	return ""
...
// system messages
type Watch struct {
	Watcher *ActorRef `protobuf:"bytes,1,opt,name=watcher" json:"watcher,omitempty"`
}
...
func (m *Watch) GetWatcher() *ActorRef {
	if m != nil {
		return m.Watcher
	}
	return nil
...
func (m *Unwatch) GetWatcher() *ActorRef {
	if m != nil {
		return m.Watcher
	}
	return nil
...
type Terminated struct {
	Who               *ActorRef `protobuf:"bytes,1,opt,name=who" json:"who,omitempty"`
...
func (m *Terminated) GetWho() *ActorRef {
	if m != nil {
		return m.Who
	}
	return nil
...
func (this *Watch) String() string {
	...
	s := strings.Join([]string{`&Watch{`,
		`Watcher:` + strings.Replace(fmt.Sprintf("%v", this.Watcher), "ActorRef", "ActorRef", 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (this *Terminated) String() string {
	...
	s := strings.Join([]string{`&Terminated{`,
		`Who:` + strings.Replace(fmt.Sprintf("%v", this.Who), "ActorRef", "ActorRef", 1) + `,`,
